...
<body class="antialiased">
    <div class="DesktopView">
        ...
        <div style="text-align: center; position: relative;">
            ...
            <div class="slide fade">
                <img src="{{ URL('IMG_9793.JPEG') }}" alt="" id="headercafe">
                <div class="slide-content">
            ...
            <div class="slide fade">
                <img src="{{ URL('IMG_9792.JPEG') }}" alt="" id="headercafe">
                <div class="slide-content">
                <h3 class="slide-title">title 2</h3>
                <p class="slide-desc">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur, necessitatibus.
...
function showSlides(n) {
  ...
  let direction = n > prevSlideIndex ? 'right' : 'left';
  prevSlideIndex = slideIndex;

  // Hide all slides and remove animation classes
  for (let i = 0; i < slides.length; i++) {
    slides[i].style.display = "none";
    slides[i].classList.remove('animate-right', 'animate-left');
  }
  ...
  slides[slideIndex - 1].classList.add(direction === 'right' ? 'animate-right' : 'animate-left');
