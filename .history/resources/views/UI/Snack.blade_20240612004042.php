...
<div id="Description">Menu makanan ringan di kopi shop umumnya mencakup berbagai pilihan yang cocok untuk dinikmati sebagai teman minum kopi atau sebagai camilan ringan di antara jam makan utama. Dengan berbagai pilihan makanan ringan yang tersedia, kampung Mahasiswa Malang dapat menjadi tempat yang ideal untuk bersantai sambil menikmati camilan favorit dan minuman favoritnya. Sambil berdiskusi dan menikmati makanan ringan untuk mengganjal perut dengan obrolan-obrolan yang mendalam.</div>
    <body>
        <div class="wrapper">
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script>
        ...
        function sendRatingToServer(columnName, rating, SnackId) {
            ...
            $.ajax({
                url: `/Snack/${SnackId}/rating`,  // Gunakan SnackId dalam URL
                type: 'POST',
