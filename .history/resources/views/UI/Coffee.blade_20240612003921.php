...
<body>
    ...
    <div id="Description">Minuman yang mengandung kopi mencakup berbagai jenis, mulai dari espresso pekat sebagai dasar, hingga variasi seperti latte, cappuccino, dan mocha yang dicampur dengan susu atau cokelat. Ada juga pilihan dingin seperti cold brew dan iced coffee, serta kombinasi kreatif yang berhasil dibuat. Setiap minuman memiliki karakteristik unik dalam rasa, tekstur, dan presentasi, memungkinkan penikmat kopi menemukan pilihan yang sesuai dengan selera mereka, baik yang menyukai rasa kuat dan pahit atau yang lebih creamy dan manis.</div>
    <div class="wrapper">
    ...
    <script src="https://mediafiles.botpress.cloud/b7d9a70e-1984-46c9-88e3-4905d3fb00ec/webchat/config.js" defer>
        @if (Auth::check())
    ...
    <script src="https://mediafiles.botpress.cloud/b7d9a70e-1984-46c9-88e3-4905d3fb00ec/webchat/v2/config.js"></script> -->
    <!-- <script src="https://cdn.botpress.cloud/webchat/v1/inject.js"></script> -->
    <!-- <script src="https://mediafiles.botpress.cloud/b7d9a70e-1984-46c9-88e3-4905d3fb00ec/webchat/v2/config.js"></script> -->
    <script src="https://cdn.botpress.cloud/webchat/v1/inject.js"></script>
<script>
  // Fungsi untuk mengirim payload dengan userid "Test"
  ...
  // Menunggu hingga webchat siap, lalu mengirim payload
    window.botpressWebChat.init({
        "composerPlaceholder": "Chat with bot",
        "botConversationDescription": "This chatbot was built surprisingly fast with Botpress",
        "botId": "b7d9a70e-1984-46c9-88e3-4905d3fb00ec",
