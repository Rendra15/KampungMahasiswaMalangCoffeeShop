        ...
        function bpListener(event){
            ...
            // @if (Auth::check())
                ...
                if(event.type === 'LIFECYCLE.READY'){
                    ...
                    window.botpressWebChdat.sendEvent({ type:'show'})
                    console.log(userid)
                }
