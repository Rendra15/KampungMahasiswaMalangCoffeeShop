        ...
        <div id="imageCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="{{ URL('LandingPage1.JPEG') }}" class="d-block w-100" alt="First slide" id="headercafe">
                </div>
                <div class="carousel-item">
                    <img src="{{ URL('LandingPage2.JPEG') }}" class="d-block w-100" alt="Second slide" id="headercafe">
                </div>
                <div class="carousel-item">
                    <img src="{{ URL('LandingPage3.JPEG') }}" class="d-block w-100" alt="Third slide" id="headercafe">
                </div>
            </div>
