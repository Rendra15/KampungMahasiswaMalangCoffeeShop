...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    // Use a more specific selector to target the button with the given classes
    const chatbotButton = document.querySelector('.bpw-widget-btn.bpw-floating-button.bpw-anim-undefined');
