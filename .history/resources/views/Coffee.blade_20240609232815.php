...
<body>
    ...
    <script src="https://cdn.botpress.cloud/webchat/v2/inject.js" defer>
        document.addEventListener('DOMContentLoaded', function() {
            if (typeof window.botpressWebChat !== 'undefined' && window.botpressWebChat.init) {
    ...
    <!-- Inject konfigurasi tambahan jika diperlukan -->
    <script src="https://mediafiles.botpress.cloud/b7d9a70e-1984-46c9-88e3-4905d3fb00ec/webchat/v2/config.js" defer></script>
    ...
    <script>
        ...
        function getRatingByCoffeeId(coffeeId) {
    $.ajax({
        url: `/coffee/${coffeeId}/rating`,
        type: 'GET',
        success: function(response) {
            if (response.rating !== undefined) {
                console.log('Rating for coffee', coffeeId, ':', response.rating);
                // Lakukan sesuatu dengan rating yang diterima, misalnya, tampilkan di halaman
            } else {
                console.error('Rating not found for coffee', coffeeId);
            }
        },
        error: function(xhr, status, error) {
            console.error('Error:', error);
