    ...
    <div class="DesktopView">
        ...
        <div id="imageCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <img src="{{ URL('Logo.png') }}" alt="" style="position: absolute; top: 20%; left: 45%; width: 150px; height: 160px;">
        <div id="TittleCafe" style="position: absolute; top: 60%; left: 51%; transform: translate(-50%, 0%);">KAMPUNG MAHASISWA MALANG</div>
                </div>
                <div class="carousel-item">
                <img src="{{ URL('IMG_9792.JPEG') }}" class="d-block w-100" alt="Second slide" id="headercafe">
                <img src="{{ URL('Logo.png') }}" alt="" style="position: absolute; top: 20%; left: 45%; width: 160px; height: 160px;">
        <div id="TittleCafe" style="position: absolute; top: 60%; left: 51%; transform: translate(-50%, 0%);">KAMPUNG MAHASISWA MALANG</div>
                </div>
                <div class="carousel-item">
