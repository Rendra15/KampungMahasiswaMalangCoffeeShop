        ...
        <div style="background-color:#073C21;height:571px">
            ...
            <div style="display:flex;align-items: start;">
                ...
                <div style="margin-left:13%; display: flex; flex-direction: column; gap: 20px;">
                    ...
                    <!-- <a href="https://www.tiktok.com/@kampungmahasiswamalang" target="_blank" id="TittleCafe" style="padding-top: 7%;font-weight:300; font-size:16px;text-align:left;width:100%">NiagaHoster</a> -->
            ...
            <div style="margin-left:5%;text-align:left;margin-top: -30px;display:flex">
                ...
                <a href="https://www.tiktok.com/@kampungmahasiswamalang" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="33" height="33" fill="currentColor" class="bi bi-tiktok" viewBox="0 0 16 16">
