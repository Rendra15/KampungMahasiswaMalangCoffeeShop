...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <style>
        ...
        .carousel-item img {
            ...
            transition: opacity 0.1s ease; /* Transisi untuk mengatur kecepatan fading */
        ...
        .carousel-item {
            ...
            position: relative;
            opacity: 0;
            transition: opacity 0.9s ease; /* Transisi untuk mengatur kecepatan fading */
        }
        ...
        .carousel-item-next:not(.carousel-item-start), .carousel-item-prev:not(.carousel-item-end), .carousel-item.active {
