...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <style>
        ...
        .carousel-item img {
            ...
            object-fit: cover; /* Menutupi seluruh area tanpa mengubah rasio aspek */
        }
...
<body class="antialiased">
        ...
        <!-- <div id="imageCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <img src="{{ URL('Logo.png') }}" alt="" style="position: absolute; top: 20%; left: 45%; width: 160px; height: 167px;">
    ...
    <div class="carousel-inner relative w-full overflow-hidden">
        <div class="carousel-item active relative float-left w-full">
            <img src="{{ URL('LandingPage.JPEG') }}" class="block w-full" alt="First slide" id="headercafe">
            <img src="{{ URL('Logo.png') }}" alt="" class="absolute top-[20%] left-[45%] w-40 h-42">
            <div id="TittleCafe" class="absolute top-[60%] left-1/2 transform -translate-x-1/2">KAMPUNG MAHASISWA MALANG</div>
        </div>
        <div class="carousel-item relative float-left w-full">
            <img src="{{ URL('IMG_9792.JPEG') }}" class="block w-full" alt="Second slide" id="headercafe">
            <img src="{{ URL('Logo.png') }}" alt="" class="absolute top-[20%] left-[45%] w-40 h-42">
            <div id="TittleCafe" class="absolute top-[60%] left-1/2 transform -translate-x-1/2">KAMPUNG MAHASISWA MALANG</div>
        </div>
        <div class="carousel-item relative float-left w-full">
            <img src="{{ URL('IMG_9793.JPEG') }}" class="block w-full" alt="Third slide" id="headercafe">
            <img src="{{ URL('Logo.png') }}" alt="" class="absolute top-[20%] left-[45%] w-40 h-42">
            <div id="TittleCafe" class="absolute top-[60%] left-1/2 transform -translate-x-1/2">KAMPUNG MAHASISWA MALANG</div>
        </div>
    </div>
    <button class="carousel-control-prev absolute top-0 bottom-0 left-0 z-10 flex items-center justify-center p-0 text-center border-0 hover:outline-none hover:no-underline focus:outline-none focus:no-underline" type="button" data-bs-target="#imageCarousel" data-bs-slide="prev">
        <span class="carousel-control-prev-icon inline-block bg-no-repeat" aria-hidden="true"></span>
        <span class="visually-hidden">Previous</span>
    </button>
    <button class="carousel-control-next absolute top-0 bottom-0 right-0 z-10 flex items-center justify-center p-0 text-center border-0 hover:outline-none hover:no-underline focus:outline-none focus:no-underline" type="button" data-bs-target="#imageCarousel" data-bs-slide="next">
