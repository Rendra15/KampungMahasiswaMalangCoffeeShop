...
Route::get('/Menu-ModernDrink/{coffeeId}/rating', [ModernDrinkController::class, 'getRating']);
Route::get('/Menu-TraditionalDrink/{coffeeId}/rating', [TraditionalDrinkController::class, 'getRating']);
Route::get('/Menu-Coffee/{coffeeId}/rating', [FoodController::class, 'getRating']);
Route::get('/Menu-Coffee/{coffeeId}/rating', [SnackController::class, 'getRating']);
