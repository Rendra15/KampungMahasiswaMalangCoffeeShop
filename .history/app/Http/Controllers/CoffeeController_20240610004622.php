...
class CoffeeController extends Controller
{
    ...
    {
        $ratingColumns = [
            'Ice_Coffee_ori' => 'Ice_Coffee_ori',
            'Americano' => 'Americano',
            'Ice_Coffee_Hazel' => 'Ice_Coffee_Hazel',
            // Tambahkan kolom rating lainnya di sini
        ];
        ...
        if ($coffee) {
            ...
            Log::info('No rating found for coffee', ['coffee_id' => $coffeeId]);
