...
function sendRatingToServer(columnName, rating, ID) {
    debugger
    console.log(columnName, rating, ID);
    ...
    $.ajax({
        url:`/Menu-Coffee/${ID}/rating`,  // Replace '1' with the actual coffee ID
        type: 'POST',
            ...
            if (cardProductName === productName) {
                ...
                for (let j = 1; j <= 5; j++) {
                    ...
                    star.addEventListener('click', function () {
                        ...
                        sendRatingToServer(validId, rating, ID);
                    });
