            ...
            <div class="signin-signup">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="input-field">
                        ...
                        @error('name')
                            <span class="invalid-feedback" role="alert" style="width:1000px;color:red;margin-left:100%">
                                <strong>{{ $message }}</strong>
                            </span>
                        @enderror
                        @error('email')
                            <span class="invalid-feedback" role="alert" style="width:1000px;color:red">
                                <strong>{{ $message }}</strong>
                            </span>
                        @enderror
                        @error('password')
