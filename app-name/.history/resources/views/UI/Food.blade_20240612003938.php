...
<div id="Description">Menu  makanan ini mencakup pilihan-pilihan yang lebih substansial dan memuaskan untuk mengisi perut. Terdiri dari mie ataupun berbagai macam nasi telur yang dimasak sepenuh hati untuk menyajikan hidangan terenak untuk pelanggan. Hal ini menjadikan Kampung Mahasisea Malang menjadi tempat yang cocok untuk makan siang atau makan malam santai bersama teman atau keluarga.</div>
    <body>
        <div class="wrapper">
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script>
        ...
        function sendRatingToServer(columnName, rating, FoodId) {
            ...
            $.ajax({
                url: `/Food/${FoodId}/rating`,  // Gunakan FoodId dalam URL
                type: 'POST',
