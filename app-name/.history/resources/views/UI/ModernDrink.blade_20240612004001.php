...
<div id="Description">Minuman modern adalah berbagai jenis minuman yang sering kali inovatif dan trendi, memadukan rasa, tekstur, dan presentasi yang unik. Modern drik ini memilki berbagai rasa yang menarik  yang dapat disajikan dalam keadaan dingin maupun hangat. Minuman-minuman ini tidak hanya menawarkan rasa yang lezat tetapi juga sering kali memiliki daya tarik visual yang tinggi, menjadikannya populer di kalangan generasi muda yang sering membagikan pengalaman kuliner mereka di media sosial. Minuman-modern ini mencerminkan tren terkini dalam inovasi kuliner, menawarkan pengalaman yang unik dan beragam bagi para penikmatnya.</div>
    <body>
        <div class="wrapper">
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script>
        ...
        function sendRatingToServer(columnName, rating, ModernDrinkId) {
            ...
            $.ajax({
                url: `/ModernDrink/${ModernDrinkId}/rating`,  // Gunakan ModernDrinkId dalam URL
                type: 'POST',
