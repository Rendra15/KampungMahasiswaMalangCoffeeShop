...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <nav class="navbar navbar-expand-lg " style="border-bottom: 2px solid #073C21;background-color:#5F5D5E">
    <a class="navbar-brand" href="/" style="margin-left: 5%;font-family:font-family: Inter, sans-serif;color: #FFFFFF;font-style:italic">Kampung Mahasiswa Malang</a>
