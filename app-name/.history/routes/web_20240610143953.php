...
Route::post('/Meu-TraditionalDrink/{id}/rating', [TraditionalDrinkController::class, 'storeRating'])->middleware('auth');
Route::post('/Food/{id}/rating', [FoodController::class, 'storeRating'])->middleware('auth');
Route::post('/Snack/{id}/rating', [SnackController::class, 'storeRating'])->middleware('auth');

Route::get('/Menu-Coffee/{coffeeId}/rating', [CoffeeController::class, 'getRating']);
Route::get('/Menu-NonCoffee/{coffeeId}/rating', [CoffeeController::class, 'getRating']);
Route::get('/Menu-Coffee/{coffeeId}/rating', [CoffeeController::class, 'getRating']);
Route::get('/Menu-Coffee/{coffeeId}/rating', [CoffeeController::class, 'getRating']);
Route::get('/Menu-Coffee/{coffeeId}/rating', [CoffeeController::class, 'getRating']);
Route::get('/Menu-Coffee/{coffeeId}/rating', [CoffeeController::class, 'getRating']);
