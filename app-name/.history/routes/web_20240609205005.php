...
// Route::post('/Menu-Coffee/{id}/rating', [NonCoffeeController::class, 'storeRating'])->middleware('auth');
// Route::post('/Menu-NonCoffee/{id}/rating', [ModernDrinkController::class, 'storeRating'])->middleware('auth');
// Route::post('/Menu-Coffee/{id}/rating', [TraditionalDrinkController::class, 'storeRating'])->middleware('auth');
