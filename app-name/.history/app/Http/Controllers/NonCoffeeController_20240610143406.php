    ...
    public function getRating(Request $request, $noncoffeeId)
    {
        ...
        if ($noncoffee) {
            if ($noncoffee->$columnName !== null) {
                ...
                Log::info('Rating found', ['coffee_id' => $noncoffeeId, 'column' => $columnName, 'rating' => $rating]);
                return response()->json(['column' => $columnName, 'rating' => $rating]);
            } else {
                Log::info('No rating found for coffee', ['coffee_id' => $noncoffeeId, 'column' => $columnName]);
